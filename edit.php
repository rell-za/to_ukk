    ...
    <div class="container mt-4">
        ...
        <form method="post" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select class="form-select" name="kategori_barang" id="kategori_barang" required>
                    ...
                    while ($k = mysqli_fetch_assoc($kategori)) {
                        $selected = ($data['kategori_barang'] == $k['nama_kategori']) ? "selected" : "";
            ...
            <div class="col-md-4">
                ...
                <input type="number" class="form-control" name="jumlah_stok" id="jumlah_stok" value="<?= $data['jumlah_stok']; ?>">
            </div>

            <div class="col-md-4">
                <label for="harga_barang" class="form-label">Harga Barang</label>
                <input type="number" step="0.01" class="form-control" name="harga_barang" id="harga_barang" value="<?= $data['harga_barang']; ?>">
            </div>

            <div class="col-md-4">
                <label for="tanggal_masuk" class="form-label">Tanggal Masuk</label>
                <input type="date" class="form-control" name="tanggal_masuk" id="tanggal_masuk" value="<?= $data['tanggal_masuk']; ?>">
            </div>
        ...
        if (isset($_POST['submit'])) {
            ...
            if (empty($errors)) {
                ...
                echo "<div class='alert alert-success mt-3'>Data barang berhasil diupdate.</div>";
            } else {
